    ...
    <>
      ...
      <div className="articles-table-wrap">
        <table>
          ...
          <tbody>
            {articles.map((a) => {
              // ✅ FIXED IMAGE URL (NO LOCALHOST)
              const imgSrc = a.image?.startsWith('http')
                ? a.image
                : a.image
                ? `${API_URL}${a.image}`
                : `https://picsum.photos/seed/${a._id}/120/80`;
                ...
                <tr key={a._id}>
                  <td>
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = 'https://picsum.photos/120/80';
                      }}
                    />
                  </td>
                  ...
                  <td>
                    <span
                      className={`badge ${
                        a.published ? 'badge-published' : 'badge-draft'
                      }`}
